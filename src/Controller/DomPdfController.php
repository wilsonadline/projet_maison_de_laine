...
{
    // fonction permettant de générer un PDF
    #[Route('/dom/pdf/{order_id}', name: 'dom_pdf', methods: ["GET"])]
    public function domPdf($order_id, OrderRepository $orderRepository)
    {
        // j'instancie un nouvel objet Options, puis j'intialise la police du PDF
        $options = new Options();
        $options->set('defaultFont', 'Arial');

        // j'instancie un nouvel objet Dompdf avec en parametre l'option de police
