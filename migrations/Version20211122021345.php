 ...
 */
final class Version20211122021345 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE taille (id INT AUTO_INCREMENT NOT NULL, taille DOUBLE PRECISION DEFAULT \'NULL\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE adresses CHANGE created_at created_at DATETIME DEFAULT \'NULL\'');
