 ...
 */
final class Version20211017214648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD articles_id INT DEFAULT NULL, ADD reference VARCHAR(255) NOT NULL, ADD price DOUBLE PRECISION NOT NULL, CHANGE users_id users_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F52993981EBAF6CC FOREIGN KEY (articles_id) REFERENCES articles (id)');
        $this->addSql('CREATE INDEX IDX_F52993981EBAF6CC ON `order` (articles_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP FOREIGN KEY FK_F52993981EBAF6CC');
        $this->addSql('DROP INDEX IDX_F52993981EBAF6CC ON `order`');
        $this->addSql('ALTER TABLE `order` DROP articles_id, DROP reference, DROP price, CHANGE users_id users_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE type_categories CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
