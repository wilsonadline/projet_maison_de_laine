 ...
 */
final class Version20211118015901 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adresses DROP orders_id, CHANGE created_at created_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adresses ADD orders_id INT NOT NULL, CHANGE created_at created_at DATETIME DEFAULT \'NULL\'');
