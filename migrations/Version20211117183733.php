 ...
 */
final class Version20211117183733 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_line (id INT AUTO_INCREMENT NOT NULL, articles_id INT DEFAULT NULL, orders_id INT DEFAULT NULL, prix INT NOT NULL, quantite INT NOT NULL, INDEX IDX_9CE58EE11EBAF6CC (articles_id), INDEX IDX_9CE58EE1CFFE9AD6 (orders_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
