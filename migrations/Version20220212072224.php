 ...
 */
final class Version20220212072224 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE delivry ADD image_name VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE delivry DROP image_name, CHANGE options options VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
