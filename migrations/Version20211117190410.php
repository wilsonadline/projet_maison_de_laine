 ...
 */
final class Version20211117190410 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD order_status_id INT NOT NULL, CHANGE adresse_id adresse_id INT DEFAULT NULL, CHANGE created created DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP order_status_id, CHANGE adresse_id adresse_id INT DEFAULT NULL, CHANGE created created DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE order_line CHANGE articles_id articles_id INT DEFAULT NULL, CHANGE orders_id orders_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE type_categories CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
