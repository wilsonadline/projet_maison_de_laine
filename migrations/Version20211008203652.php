 ...
 */
final class Version20211008203652 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_BFDD316823A0E663C0D87E56DE44026F7EFEA5E ON articles');
        ...
        $this->addSql('CREATE FULLTEXT INDEX IDX_3AF346686C6E55B5 ON categories (nom)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE FULLTEXT INDEX IDX_BFDD316823A0E663C0D87E56DE44026F7EFEA5E ON articles (article, couleur, description)');
        $this->addSql('DROP INDEX IDX_3AF346686C6E55B5 ON categories');
