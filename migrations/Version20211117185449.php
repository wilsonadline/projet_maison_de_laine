 ...
 */
final class Version20211117185449 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE adresse_id adresse_id INT DEFAULT NULL, CHANGE created created DATETIME DEFAULT NULL');
