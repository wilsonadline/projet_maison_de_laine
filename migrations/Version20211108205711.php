 ...
 */
final class Version20211108205711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adresses DROP type_ad, CHANGE created_at created_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adresses ADD type_ad INT NOT NULL, CHANGE created_at created_at DATETIME DEFAULT \'NULL\'');
