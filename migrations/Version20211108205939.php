 ...
 */
final class Version20211108205939 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adresses ADD type_adresses_id INT DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE adresses ADD CONSTRAINT FK_EF192552CEF890B7 FOREIGN KEY (type_adresses_id) REFERENCES type_adresses (id)');
        $this->addSql('CREATE INDEX IDX_EF192552CEF890B7 ON adresses (type_adresses_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adresses DROP FOREIGN KEY FK_EF192552CEF890B7');
        $this->addSql('DROP INDEX IDX_EF192552CEF890B7 ON adresses');
        $this->addSql('ALTER TABLE adresses DROP type_adresses_id, CHANGE created_at created_at DATETIME DEFAULT \'NULL\'');
