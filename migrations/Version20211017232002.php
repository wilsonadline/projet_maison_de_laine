 ...
 */
final class Version20211017232002 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE users_id users_id INT DEFAULT NULL, CHANGE articles_id articles_id INT DEFAULT NULL');
